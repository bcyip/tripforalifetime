...
<?php if ( !is_page() ) : ?><br /><span class="s_category"><span class="fa fa-folder-open-o"></span><?php the_category(', '); ?></span><br />
<?php endif; ?>
...
<span class="fa fa-comment"></span><span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'the-columnist' ), __( '1 Comment', 'the-columnist' ), __( '% Comments', 'the-columnist' ) ); ?></span></span>
<?php endif; edit_post_link( __( 'Edit', 'the-columnist' ), '<span class="s_edit"><span class="fa fa-edit"></span><span class="edit-link">', '</span></span>' ); ?>
</footer>