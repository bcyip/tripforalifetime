...
<div id="bloglist">
  ...
  <div id="mainheader">
      <h1 class="archive-tit">
          <?php
              if ( is_day() ) :
                  printf( __( 'Daily Archives: %s', 'the-columnist' ), get_the_date() );
  
              elseif ( is_month() ) :
                  printf( __( 'Monthly Archives: %s', 'the-columnist' ), get_the_date('F Y') );
  
              elseif ( is_year() ) :
                  printf( __( 'Yearly Archives: %s', 'the-columnist' ), get_the_date('Y') );
  
              else :
                  _e( 'Archives', 'the-columnist' );
